...
class CreateShoppingItems(Form):
    ...
    product_description=TextAreaField('Enter Product Description and Clinic Name',[validators.Length(min=8,max=150), validators.DataRequired()])
    price=FloatField('Enter Product Price')
