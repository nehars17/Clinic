...
def send_delete_otp_email(email, otp):
    message = EmailMessage()
    message["Subject"] = "Clinic 24/365 - One Time Pin"
    message["From"] = "web.clinic.24.365@gmail.com"
    message["To"] = email
    ...
    <html>
        <body>
            <h1>CLINIC 24/365</h1>
            <br>
            <p>This is the One Time Pin to delete your account.
            <br>
            <b> {otp} </b>
            </p>
...
class PublicOTP:
    ...
    def send_delete_email(self, email, otp):
        send_delete_otp_email(email, otp)
